...
public class Debit_Note {
    ...
    public void pdfcreate() {
        ...
        String outPath = Environment.getExternalStorageDirectory() + "/mypdfff.pdf";
...
//Second table
            ...
            PdfPCell cel22 = new PdfPCell(new Phrase("Dcoument number :"));
            ...
            cel22 = new PdfPCell(new Phrase("Date of invoice :"));
            //cell1.setBorder(Rectangle.NO_BORDER);
            cel22.setHorizontalAlignment(Element.ALIGN_LEFT);
            innertable22.addCell(cel22);
