...
public class tax_invoice2 {
    ...
    String invoice_id,invoice_date,user_com,user_add,user_gst,user_cp,client_com,client_add,client_state,client_zip,client_gst,total,accno,ifsc;
        ArrayList<String[]> items;
        ArrayList<String[]> GST;

        public tax_invoice2(String invoice_id, String invoice_date, String user_com, String user_add, String user_gst, String user_cp, String client_com, String client_add, String client_state, String client_zip, String client_gst, ArrayList<String[]> items, ArrayList<String[]> gsts, String total,String accno,String ifsc)
        {
